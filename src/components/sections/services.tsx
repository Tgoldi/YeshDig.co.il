...
const services = [
  {
    ...
    description: "כולל מחקר מילים של עד 5/8 מילות מפתח, בדיקת ושיפור מהירות אתר, בדיקת תאימות למובייל, הטמעת מטא טאגז, אופטמיזציית תוכן כוללת לאתר והגדרת Google Search Console ו Google Analytics."
  },
  {
    icon: Target,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            פתרונות דיגיטליים וקבלת מעטפת רחבה מעבר לטובת הצלחת העסק שלך
          </p>
        </div>
