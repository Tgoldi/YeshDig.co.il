...
const faqs = [
  {
    ...
    answer: "קידום אורגני (SEO) מקצועי דורש תהליך יסודי הכולל מחקר מילים, אופטימיזציית תוכן וחקר שוק.אנחנו מאמינים בשקיפות מלאה ובניית נוכחות דיגיטלית יציבה, גם אם זה אומר להגיד ללקוח את האמת על התהליך והזמן הנדרש. גוגל מזהה ומתגמל עבודה מקצועית ויסודית - וזו הדרך היחידה שלנו."
  },
  {
