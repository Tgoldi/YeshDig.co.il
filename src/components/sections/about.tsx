      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h2 className="text-3xl font-bold gradient-text">למה לבחור בנו?</h2>
            <p className="text-muted-foreground text-lg leading-relaxed">
            אנחנו מאמינים בשילוב של מקצועיות, חשיבה מחוץ לקופסא ושירות אישי. הצוות שלנו מורכב מאנשים מומחים בתחומם שחשוב להם הצלחת הלקוח לפני הכל.            </p>
